...
private:
    ...
    void uninitVarError(const Token *tok, bool isprivate, Function::Type functionType, const std::string &classname, const Variable *var, bool inconclusive);
    ...
    void getErrorMessages(ErrorLogger *errorLogger, const Settings *settings) const OVERRIDE {
        ...
        c.uninitVarError(nullptr, false, Function::eConstructor, "classname", nullptr, false);
        c.uninitVarError(nullptr, true, Function::eConstructor, "classname", nullptr, false);
